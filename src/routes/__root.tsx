...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GRAIN — Disposable camera for the night" },
      { name: "description", content: "Scan, shoot 5, wait til morning. A delayed-reveal disposable camera for parties & festivals." },
      { name: "author", content: "GRAIN" },
      { property: "og:title", content: "GRAIN — Disposable camera for the night" },
      { property: "og:description", content: "Scan, shoot 5, wait til morning." },
